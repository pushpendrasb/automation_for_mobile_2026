...
const ALL_TEST_CASES = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Name Paul, email sami@appdesign.ie, random mobile — typed in place, no scroll to Next first',
      'Plate 141D6333, scroll only if registration is off screen',
      'Trade In lookup → mileage → NEXT',
      'Damage tyre/alloy (env) + photos if DAMAGE',
      'Vehicle Photos — add one image per cell from app_images_mandatory, then SAVE',
    ],
